...
function solid_actor(a,dx,dy)
  ...
  if a2!=a then
   ...
   then 
    -- collision damage?
    if a2.contact_t<time_t and a.dmg and (a.side==any_side or a.side!=a2.side) and a2.hit then
    	a2.contact_t=time_t+60
    	a2:hit(a.dmg)
    	printh("contact dmg:"..a.dmg)
    end
