...
function move_actor(a)
 ...
 -- fix idle plyr=god mode!
	if a!=plyr and not a.dmg and bor(a.dx,a.dy)==0 then
		zbuf_write(a)
		return
	end
	-- remove old position 
