...
function cam_pixel_scale(z)
	local y=-cam_y
	z-=cam_z
	local ze=-(y*cam_cb+z*cam_sb)
	return -ze/cam_focal
end
function cam_track(x,y,z,d)
	cam_x=x
	cam_y=y-cam_cb*d
	cam_z=z-cam_sb*d
end
...
function spawn_blt(x,y,z,dx,dy,dz,side)
	...
	if(side==good_side) b.sx=120 b.sy=0
	blts_c+=1
	blts[blts_c]=b
	sfx(3)
	return b
...
function spawn_bship(x,y)
 y+=218
	...
	-- parts
	local scale=1.296--cam_pixel_scale(boss.z)
	printh("scale:"..scale)
	for j=1,32 do
		local py=-scale*(j-16)*8
		for i=0,3 do
			local t=nil
...
function bship_draw(self,x,y,z,w)
	map(2,0,x-8*8/2,y-31*8/2,4,31)
	map2(2,0,x,y-31*8/2,4,31)
end
function turret_draw(self,x,y,z)
	palt(4,true)
	palt(3,false)
	if(self.hit) pal(8,8+flr(time_t/16)%3)
	sspr(self.sx,self.sy,16,16,x,y,16,16)
	palt(4,false)
	palt(3,true)
	pal(8,8)
end
...

...

...
__map__

...

