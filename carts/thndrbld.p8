...
function world_update()
	-- pick world items
	local plyr_cur=flr((plyr.y+world_in)/world_scaley)
...
function flr_chase_draw(self,x,y,z,w)
	local ww,wh=flr_w*w,flr_zmax*w
...
function spawn_building(x,y,ramps)
	...
	if cam_is_top_down() then		
		...
		add(b.floors,{x=x,y=y,z=flr_n*flr_h,i=flr_n,ramps=ramps,draw=roof_draw})
	else
...
function spawn_tracker_blt(x,y,z,dz,side)
	local dx,dy=normz(plyr.x-x,plyr.y+40-y)
	dx*=1.5
	dy*=1.5
...
function spawn_bship(x,y)
 y+=256
	...
	local k=1
	for i=1,3 do
		boss_struct[k]={x=x,y=y+160/3,z=i*6,s=201,draw=spr_draw}
		boss_struct[k+1]={x=x,y=y+96/3,z=4*i,s=205,draw=spr_draw}
		k+=2
	end
	boss_struct[k]={x=x,y=y+96/3,z=24,s=203,draw=spr_draw}
	return boss
end
...
function to_chase()
	futures_add(function()
		...
		plyr_playing=false
		flr_n,flr_zmax=4,96
		plyr_zmin,plyr_zmax=3,86
		cam_rotate_async(0,72,1)
		world_out,world_in=-32,512
		plyr_blt_dy=2.853-- -3*cos(0.55)
		plyr_blt_dz=-0.9268-- -3*sin(0.55)
...
function to_top_down()
	futures_add(function()
		blts_c,nmies_c=0,0
		plyr_playing=false
		flr_n,flr_zmax=7,7*flr_h
		plyr_zmin,plyr_zmax=0,flr_zmax+16
		cam_rotate_async(72,0,-1)
		world_out,world_in=-100,150
		plyr_blt_dy=2.187-- -3*cos(0.62)
		plyr_blt_dz=-2.187-- -3*sin(0.62)
		plyr_r=12
		plyr_scale=1
		plyr_playing=true
	end)
...

...

