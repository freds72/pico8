...
local plyr
local spawn_t=0
local actors,ground_actors,npc_count={},{},0
local parts={}
...
_g.die_vent=function(self)
	...
	futures_add(function()
		...
		if escape then
			make_msg("victory2")
			local wing=make_npc({0,50,0},v_up,all_actors["mfalcon"])
			wing.target=plyr
			plyr_playing=false
			set_view(false)
			wait_async(16)
			...
			game_mode=3
			wait_async(60)
			make_part("novablast",{0,0,0})
			-- todo: gameover
		else
			plyr:die()
		end
	end)
	-- todo death star blast
end
...
local all_actors=json_parse'{"plyr":{"score":0,"hp":5,"safe_t":0,"energy":1,"energy_t":0,"boost":0,"acc":0.2,"model":"xwing","roll":0,"pitch":0,"laser_i":0,"fire_t":0,"lock_t":0,"proton_t":0,"proton_ammo":4,"side":"good_side"},"xwing":{"hp":8,"acc":0.2,"g":0,"overg_t":0,"model":"xwing","side":"good_side","update":"update_flying_npc","hit":"hit_npc"},"tie":{"hp":4,"acc":0.2,"g":0,"overg_t":0,"model":"tie","side":"bad_side","update":"update_flying_npc","hit":"hit_flying_npc"},"turret":{"hp":2,"model":"turret","side":"bad_side","update":"update_ground_npc","hit":"hit_npc"},"generator":{"waypt":true,"hp":2,"model":"generator","side":"bad_side","update":"nop","hit":"hit_npc"}}'
...

__map__

