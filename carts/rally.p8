...
function draw_model(model,m,pos,outline)
	...
	if not outline then
 	...
 	for _,f in pairs(faces) do
 		...
 		-- todo bench against table lookup
 		c=sget(c+8,f.c)		
 		local p0=p[f.vi[1]]
  		for i=2,#f.vi-1 do
	...
	for _,e in pairs(model.e) do
		-- edge must have at least 1 visible and 1 not visible face
		local viz=0
		for _,fi in pairs(e.fi) do
			viz=bor(viz,model.f[fi].viz)
		end
		if viz==3 then
			local p0,p1=p[e[1]],p[e[2]]
...
_g.draw_spr_actor=function(self)
	...
	palt(0,false)
	palt(14,true)
	sspr(self.sx,self.sy,16,16,x-w,y-w,w,w)
	pal()
end

local all_actors=json_parse'{"plyr":{"model":"audi","hardness":0.02,"mass":16,"turn":0,"traction":0,"traction_ratio":0,"control":"control_plyr","update":"update_plyr","draw_shadow":"draw_plyr_shadow"},"tree":{"model":"tree","update":"nop","draw":"draw_spr_actor","sx":56,"sy":16}}'
...
function _draw()
 ...
 if #ghost>2*60 then
 	...
 	draw_model(all_models["audi"],ghost_m,ghost_p,true)
 end
...
__gfx__

...

...

...

__sfx__
