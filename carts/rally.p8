...
function add_tireforce(self,v,offset,scale,isrear)
 -- force to world
	...
	if not ratio then
		...
		-- sliding?
		local max_traction=isrear and 32 or 32
		...
		draw=function(self)
		 for i=1,#segments do
			 ...
			 x,y,z,w=cam:project(v.pos[1],get_altitude_and_n(v.pos),v.pos[3])
				spr(i<=self.i and 32 or 48,x-4,y-4)
			end
		end
	}
	t.length=#segments
...
function time_tostr(t)
 -- frames per sec
	return padding(flr(t/1800)).."'"..padding(flr(t/30)%60).."''"..padding(flr(10*t/3)%100)
end
...
function _draw()
 ...
 draw_hud()
	...
	print("done:"..(track:is_over() and "yes" or "no"),2,8,7)
	print("time:"..time_tostr(track.t),2,16,7)	
 for i=1,#track.chrono do
 	local c=track.chrono[i]
 	print(i..":"..time_tostr(c),2,22+i*6,6)
 end
...

...

...
0a00b0f0029061c09081b0428003a1232203c2a2e202d24172
__gff__
