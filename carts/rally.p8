...
_g.control_plyr=function(self)
 ...
 --[[
	...
	if v_dot(self.v,self.v)>k_small then
		...
		add_tireforce(self,{-sin(angle),0,cos(angle)},10)
		-- rear wheels
...
--[[
function draw_vector(m,a,v,c)
	--v=m_x_v(m,v)
	local x0,y0,z0,v0=cam:project(a[1],a[2],a[3])
	local x1,y1,z1,v1=cam:project(a[1]+v[1],a[2]+v[2],a[3]+v[3])
	line(x0,y0,x1,y1,c)	
end
]]
...
function _init()
 ...
 local perlin=""
	...
	local rleq=""
	local i=1
	local read_nibles=function(n)
		local v=tonum("0x"..sub(rleq,i,i+n-1))
		i+=n
		return v
	end
	while i<=#qmap do
		-- coordinates
		local idx=read_nibles(4)
		-- count
		local count=read_nibles(2)
		for j=0,count-1 do
			local q=read_nibles(1)
			local c=read_nibles(1)
			qmap[idx+j]=bor(q,shr(c,4))
		end
	end
...
__gfx__

...

